...
const KPITooltip: React.FC<KPITooltipProps> = ({ text, content, children }) => (
  <span className="relative group inline-flex items-center gap-1 cursor-help">
    ...
    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2.5 rounded-xl bg-gray-900 text-white text-xs leading-relaxed w-80 max-w-xs opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 shadow-xl pointer-events-none">
